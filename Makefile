...
2ndgen:
	...
	gcc -Wall -Wextra -DOVERRIDE_STD std.c codegen.c self_compile_asm/alignment.s parse_analyze_toplevel.c parse_analyze_statement.c self_compile_asm/codegen_expression.s main.c self_compile_asm/vector.s typecheck_expression.c parse_expression.c error.c type.c parse_type.c self_compile_asm/map.s self_compile_asm/print_x86_64.s $(OSFLAG) lexer.c -o out/compiler.out
