...
full_compile:
	...
	./test_ret4.sh 077 'main(){a =0; b=0; do{b+=--a;}while(a+3); return b*a;}' 18 out/compiler.out
	./test_ret4.sh 076 'main(){a=3; b=0; b+= a++; return !(b-3)+!(a-4)+172;}' 174 out/compiler.out
	./test_ret4.sh 075 'main(){a=3; b=0; b+= ++a; return a*b*11-2;}' 174 out/compiler.out
	./test_ret4.sh 074 'main(){a =0; b=0; do{a-=1;b+=a;}while(a+3); return b*a;}' 18 out/compiler.out
	...
	./test_ret4.sh 053 'main() {a = 4; if(1){return 170+a; a = 7; }else{return 170-a; a = 9;} a = 5; return a;}' 174 out/compiler.out
	./test_ret4.sh 054 'foo(){return 1;}main(){a=0;do{a=3;}while(a==foo());return 174;}' 174 out/compiler.out
	./test_ret4.sh 055 'main(){a=0;do{a+=1;}while(a && a < 174);return a;}' 174 out/compiler.out
	...
	./test_ret4.sh 059 'main(){a = 3;while (a) {a = 2;if (a - 3) {break;}a += 3;}return 174;}' 174 out/compiler.out
